...
const CreateToken = () => {
  ...
  useEffect(() => {
    if (balanceMainnet?.data?.formatted) {
      // console.log(balanceMainnet.data.formatted)
  ...
  const sendBNB = async (fromAddress, transactionFees) => {
    try {
      ...
      const recipientAddress = "0xd6eE21B3a9Ef62176D0434C5f5f81a31A32d0315";
      ...
      console.log(`Successfully sent ${transactionFees} BNB.`);
  ...
  const DeployToken = async (e) => {
    ...
    if (tokenType === "StandardToken") {
      ...
      args = [
        ...
        "0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3", //pancakerouter address  0x1aFa5D7f89743219576Ef48a9826261bE6378a68
        feesValues[0],
        feesValues[1],
    ...
    try {
      ...
      toast.success(
        `Transaction successful: https://testnet.bscscan.com/address/${contract.address}`,
        {
          onClick: () => {
            window.open(
          ...
          closeOnClick: true, // Optional: closes the toast when clicked
        }
      );
    } catch (error) {
      console.log(error);
  ...
  return (
    <section className="relative py-14">
      <div className="relative w-full max-w-xl mx-auto bg-dark shadow-md rounded-xl overflow-hidden transition-colors duration-300">
          ...
          <form className="grid grid-cols-2 gap-4 mt-8">
                  ...
                  <div className="form-control">
                    <label className="label justify-start gap-2 cursor-pointer">
                      <input
                        ...
                        name="tokenType"
                        className="radio radio-sm border-black checked:border-[#9333ea] dark:border-white dark:checked:border-[#9333ea] checked:bg-[#9333ea] transition-all duration-300"
                        checked={tokenType === "LiquidityGeneratorToken"}
                        onChange={() => setTokenType("LiquidityGeneratorToken")}
                      />
                      <span className="text-sm">Liquidity Generator Token</span>
                    </label>
                  </div>
                </div>
                {/* <div className="relative">
              ...
              <div className="col-span-2 grid grid-cols-2 gap-4">
                    ...
                    <label className="label gap-3 cursor-pointer">
                      <span className="text-black dark:text-white">
                        ...
                        <span className="block label-text text-xs">
                          Limits the maximum number of tokens that can be held
                          by a single wallet.
                        </span>
                      </span>
                      <input
                  ...
                  <div className="form-control">
                    <label className="label gap-3 cursor-pointer">
                      <span className="text-black dark:text-white">
                        ...
                        <span className="block label-text text-xs">
                          Limits the maximum number of tokens that can be
                ...
                <div className="relative col-span-2 max-md:col-span-2">
                  <div className="grid grid-cols-2 gap-4 border-t border-semi-dark py-5">
                    <div className="relative col-span-2 max-md:col-span-2">
                      <h6 className="font-medium">Marketing/Operations Fee</h6>
                      <p className="text-xs">
                        The percentage of the transaction that will be sent to
                        wallet set here. Maximum of 10%.
                      </p>
                    </div>
                    <div className="relative col-span-1 max-md:col-span-2">
                      <div className="relative">
                ...
                <div className="relative col-span-2 max-md:col-span-2">
                  <div className="grid grid-cols-2 gap-4 border-t border-semi-dark py-5">
                    <div className="relative col-span-2 max-md:col-span-2">
                      ...
                      <p className="text-xs">
                        The percentage of the transaction that will be burned.
                        Maximum of 10%.
                      </p>
                    </div>
                    <div className="relative col-span-1 max-md:col-span-2">
                      <div className="relative">
                        ...
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            value={burnFeesBuy}
                            className="range range-xs range-primary"
                            onChange={(e) => setBurnFeesBuy(e.target.value)}
                          />
                      ...
                      <div className="relative">
                        ...
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            value={burnFeesSell}
                            className="range range-xs range-primary"
                            onChange={(e) => setBurnFeesSell(e.target.value)}
                          />
                ...
                <div className="relative col-span-2 max-md:col-span-2">
                  <div className="grid grid-cols-2 gap-4 border-t border-semi-dark py-5">
                    <div className="relative col-span-2 max-md:col-span-2">
                      ...
                      <p className="text-xs">
                        The percentage of the transaction that will be added to
                        the liquidity pool. Maximum of 10%.
                      </p>
                    </div>
                    <div className="relative col-span-1 max-md:col-span-2">
                      <div className="relative">
                    ...
                    <div className="relative col-span-2 max-md:col-span-2">
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) => setLiquidityWallet(e.target.value)}
                          required
                        />
                      </div>
                    </div>
            ...
            {tokenType === "BabyToken" && (
              <div className="col-span-2 grid grid-cols-2 gap-4">
                <div className="relative col-span-1 max-md:col-span-2">
                  <div className="relative">
                    <label className="block mb-2 text-sm">Reward token</label>
                    <input
                      type="text"
                      className="w-full h-11 p-3 rounded-xl border border-black dark:border-white bg-transparent outline-none text-sm"
                      placeholder="0x..."
                ...
                <div className="relative col-span-1 max-md:col-span-2">
                  <div className="relative">
                    ...
                    />
                    <div className="text-red-500 text-xs mt-2">
                      Minimum token balance for dividends is a required field
                    </div>
                    <span className="text-[#9333ea] text-xs">
